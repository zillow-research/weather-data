...
1. **Weather metrics data set**
    ...
    For more info, check out NOAA's [README on GSOD data](http://www1.ncdc.noaa.gov/pub/data/gsod/readme.txt), which I also linked to in [Sources and resources](#sourcesAndResources).
